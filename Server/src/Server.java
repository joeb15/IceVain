...
public class Server {
    ...
    public static void main(String[] args){
        ...
        socketManager.addInterface(SOCKET_PING, (msg, socketNum)->{
            socketServer.ping(socketNum);
        });
        socketManager.addInterface(SOCKET_BROADCAST, (msg, socketNum)->{
            System.out.println(msg);
        });
        socketManager.addInterface(SOCKET_DISCONNECT, (msg, socketNum)->{
            socketServer.disconnect(socketNum);
        });

        Timer.createTimer(()->{
            socketManager.pushMessage(SOCKET_PING,"ping");
        },1000, -1);
